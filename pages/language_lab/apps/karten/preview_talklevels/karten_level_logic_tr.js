// Leveltrainer – Preview-Variante mit Türkisch-Unterstützung (keine UI-Änderung am Original)
(function () {
  ...
  function setActiveChip(chips, lang) {
    chips.forEach((chip) =>
      chip.classList.toggle("is-active", chip.dataset.inputLang === lang || chip.dataset.outputLang === lang)
    );
  }
